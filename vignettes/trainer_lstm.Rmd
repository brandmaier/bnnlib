...
trainer <- list( ImprovedRPropTrainer(net), ImprovedRPropTrainer(net), BackpropTrainer(net), BackpropTrainer(net), QuickpropTrainer(net))

#trainer <- list( ARPropTrainer(net))


#Trainer_learning_rate_set(trainer[[4]], 0.01)
#t2 <- 
