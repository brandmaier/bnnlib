...
```{r}
net <- NetworkFactory_createFeedForwardNetwork(3,20,1)
```
...
for (i in 1:nrow(marketing)) {
  input <- as.numeric( marketing[i,1:3] )
  target <- c(marketing[i,4],0)
  Sequence_add_from_array(seq, input, target, 3, 1)
